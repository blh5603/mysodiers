				...
				<view v-for="(sodier,index) in sodiertype" :key="index" :class="'sodieritem sbg' + index">
					<view class="item-left" :style="'background:url('+sodier.image+') no-repeat center center;background-size:80% 75%;'">
						<view class="item-status">
							<image src="../../static/images/mysodiers/employing.png"></image>
						</view>
					</view>
					...
					<view class="item-right">
						<view class="attr-list">
							...
							<view class="attr-item">
								<view class="attr-left">人数：</view>
								<view class="attr-right">{{sodier.num}}</view>
							</view>
							<view class="attr-item">
							...
							<view class="attr-item" v-if="tabIndex == 0">
								<view class="employ-btn" @tap="open(index)">
									<image src="../../static/images/mysodiers/go.png" mode=""></image>
								</view>
							</view>
